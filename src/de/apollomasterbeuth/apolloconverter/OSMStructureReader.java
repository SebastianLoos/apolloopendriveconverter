...
public class OSMStructureReader {
	...
	public static Environment read(String filename, OSMReaderSettings settings) {
		...
		try {
			...
			OsmElement root = OsmUnmarshaller.unmarshal(inputStream);
	...
	public static List<Node> getNodesOnWay(Road road, List<Node> nodes){
