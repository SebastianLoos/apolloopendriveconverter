 ...
 *       &lt;sequence&gt;
 *         &lt;element name="bor" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 ...
 *         &lt;element name="sre" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlRootElement(name = "s_Bordstein")
public class SBordstein {
    ...
    protected List<SBordstein.Geom> geom;
    @XmlAttribute(name = "id", namespace = "http://www.opengis.net/gml/3.2")
    protected String id;

    /**
     * Ruft den Wert der bor-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Legt den Wert der bor-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
    ...
    /**
     * Ruft den Wert der sre-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Legt den Wert der sre-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setSre(String value) {
        this.sre = value;
    }
     ...
     * {@link SBordstein.Geom }
     * 
     * 
     */
    public List<SBordstein.Geom> getGeom() {
        if (geom == null) {
            geom = new ArrayList<SBordstein.Geom>();
        }
        return this.geom;
    }
